...
namespace EarthLink.Tests
{
    public abstract class EarthLinkTestBase : AbpIntegratedTestBase<EarthLinkTestModule>
    {
        ...
        protected void UsingDbContext(Action<EarthLinkDbContext> action)
        {
            UsingDbContext(AbpSession.TenantId, action);
        }

        protected Task UsingDbContextAsync(Action<EarthLinkDbContext> action)
        {
            return UsingDbContextAsync(AbpSession.TenantId, action);
        }

        protected T UsingDbContext<T>(Func<EarthLinkDbContext, T> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<T> UsingDbContextAsync<T>(Func<EarthLinkDbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<EarthLinkDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<EarthLinkDbContext>())
                {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Action<EarthLinkDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<EarthLinkDbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<EarthLinkDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<EarthLinkDbContext, Task<T>> func)
        {
            T result;
